...
public class ChanceController {
    ...
    public void createCards() {
        ...
        cards[4] = new ChanceMoney("Du har spist for meget slik. Betal 2 kr. til banken.", "MONEY", -2, false);
        ...
        cards[9] = new ChanceMoney("Det er din fødselsdag. Alle giver dig 1 kr.", "MONEY", 1, true);
